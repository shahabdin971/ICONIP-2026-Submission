...
## 9. Final Target-Domain Test Results

### Target test results

| Model | Transfer direction | ACC | 
|---|---|---:|
| Baseline | ADNI1 → ADNI2 | 38.67 |  
| Baseline | ADNI2 → ADNI1 | 50.00 | 
| Improvement 1 | ADNI1 → ADNI2 | 65.75 | 
| Improvement 1 | ADNI2 → ADNI1 | 55.56 | 
| Improvement 2 | ADNI1 → ADNI2 | 66.67 | 
| Improvement 2 | ADNI2 → ADNI1 | 50.00 | 
